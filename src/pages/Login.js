...
function Login() {
    ...
    return (
        <div className="App bg-gradient-to-tl from-black to-gray-500 h-screen w-screen text-white">
            ...
            <div className="login">
                <div>
                    <input className='m-4' type="text" placeholder="Username..." />
                </div>
                <div>
                    <input className='m-4' type="password" placeholder="Password..." />
                </div>
                <button className='mb-4 rounded bg-gray-600 font-bold text-md md:text-2xl text-slate-300 md:py-2 p-[5px] md:flex-1'>Login!</button>
            </div>
        </div>
    );
